    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-white text-center p-6">
        ...
        <p className="max-w-md text-white/70 mb-6">
          ...
          Testphase werden 2 CHF / Monat verrechnet. Du wirst darauf nach Deine Google API-Key gefragt, damit die KI das Bild erstellen kann. Die Key findest Du hier: https://console.cloud.google.com/. Und falls Du eine Anleitung benötigst, wähle diese Domain: https://bit.ly/API-KEY
        </p>
